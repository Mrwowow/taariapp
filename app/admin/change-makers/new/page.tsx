...
export default function NewChangeMakerPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    if (!form.title) { setError('Title / role is required.'); return; }
    setSaving(true);
    setError('');
    ...
    if (res.ok) {
      ...
      setError('Failed to create change maker.');
      setSaving(false);
    }
  }
      ...
      <form onSubmit={handleSubmit} className="bg-white rounded-xl p-6 shadow-sm border border-gray-100 space-y-5">
        ...
        <FormField label="Title / Role" htmlFor="title" required>
          <input
            ...
            placeholder="Community Organizer & Educator"
          />
        </FormField>
        ...
        <FormField label="Bio" htmlFor="bio">
          <textarea
            ...
            placeholder="Tell us about their impact and contributions…"
          />
        </FormField>
        ...
        <div className="flex gap-3 pt-2">
          ...
          >
            {saving ? 'Creating…' : 'Create Change Maker'}
          </button>
          <Link
